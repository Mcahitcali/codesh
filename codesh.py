...
def logo():
    ...
    print "--==["+bold+green+"software"+endcolor+"] [ codesh / Code Share"
    print "-"*50
...
def helpme():
    ...
    print "\t\t<< example >>"
    print "\t"+bold+"~$"+endcolor+" python codesh.py "+green+"myFirstProject.pl"+endcolor+" "+yellow+"perl"+endcolor+" "+blue+"MuReCoder"+endcolor
    print "\t"+bold+"~$"+endcolor+" python codesh.py "+green+"myFirstText.txt"+endcolor+" "+yellow+"text"+endcolor+" "+blue+"MuReCoder"+endcolor
    print ""
...
def ps_paste2(filename, language, nickname):
    ...
    br["description"] = "Copy: Code Share | GitHub: http://github.com/MuReCoder"
    source = br.submit().read()
...
# codesh.py mytext.txt text MuReCoder
